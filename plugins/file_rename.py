...
async def rename_start(client, message):
    ...
    if file.file_size > 2000 * 1024 * 1024:
         return await message.reply_text("Sᴏʀʀy Bʀᴏ Tʜɪꜱ Bᴏᴛ Iꜱ Dᴏᴇꜱɴ'ᴛ Sᴜᴩᴩᴏʀᴛ Uᴩʟᴏᴀᴅɪɴɢ Fɪʟᴇꜱ Bɪɢɢᴇʀ Tʜᴀɴ 2Gʙ. ᴄᴏɴᴛᴀᴄᴛ ʙᴏᴛ <a href='https://t.me/GwitcherG'>ᴅᴇᴠᴇʟᴏᴘᴇʀ</a>")
    ...
    try:
        if type == "document":
            await bot.send_document(
                ...
                progress_args=("⚠️__**Please wait...**__\n__Processing file upload....__", ms, time.time()))
        elif type == "video": 
